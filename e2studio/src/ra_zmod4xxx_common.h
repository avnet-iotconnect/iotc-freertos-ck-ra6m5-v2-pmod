 ...
 * Description  : Contains data structures and function declarations of ZMOD4XXX sensor
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * DISCLAIMER
...
/* Quick setup for g_zmod4xxx_sensor 0. */
extern void g_zmod4xxx_sensor0_quick_setup (void);
/* Quick setup for g_zmod4xxx_sensor 1. */
extern void g_zmod4xxx_sensor1_quick_setup (void);
/* Quick setup for g_zmod4xxx_sensor 2. */
extern void g_zmod4xxx_sensor2_quick_setup (void);

extern void start_iaq_1st_gen_demo (void);
extern void start_oaq_1st_gen_demo (void);
extern bool_t R_ZMOD4410_get_sensing_status (st_sensorsZmod4410_t *p_data);
...
extern volatile demo_callback_status_t  g_i2c_callback_status2;
extern volatile demo_callback_status_t  g_irq_callback_status2;
