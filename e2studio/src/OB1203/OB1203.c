 ...
 *
 ************************************************************************************************************************
 * This code is intended for demonstration purposes only, not for production. No performance or suitability 
* for any purpose including medical devices is guaranteed or claimed. For
...
//void setBioTrim(struct ob1203 *_ob)
//{
//    uint8_t writeData[1];
//    writeData[0] = bio_trim;
//    i2c_w(OB1203_ADDR, REG_BIO_TRIM,writeData,1);
//}
//
//void setLEDTrim(struct ob1203 *_ob)
//{
//    uint8_t writeData[1];
//    writeData[0] = led_trim;
//    i2c_w(OB1203_ADDR, REG_LED_TRIM,writeData,1);
//}
