 ...
 */
#define STATIC_IP_MAC_ADDRESS        {0x00, 0x22, 0x33, 0x44, 0x55, 0x96}
...
{
    /* Get a random number for the sequence number.
...
void net_thread_entry(void *pvParameters)
{
    ...
    /* update MAC address from FSP */
    memcpy(&g_mac_address, &g_ether0_mac_address, 6);
