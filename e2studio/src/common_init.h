...
#define SHORT_NAME      "RA6M5 v2"
#define FULL_NAME       ("CK-RA6M5 v2")
#define PART_NUMBER     ("RTK7CKA6M5Sxx002BE")
#define DEVICE_NUMBER   ("R7FA6M5BH3CFC")

#define KIT_NAME                (FULL_NAME)
#define EP_VERSION              ("1.02")
...
#define MENU_RETURN_INFO2  "\r\n                                                   \r\n  Page may take 30-seconds to refresh\r\n> Press space bar to return to MENU\r\n"
...
typedef struct sensorsHS_t {
    ...
    float32_t                  temperature; /*/< Temperature*/
    float32_t                  humidity;    /*/< Humidity*/
} st_sensorsHS_t;
...
typedef struct sensorsICP_t {
    ...
    float32_t                  temperatureicp; /*/< Temperature*/
    float32_t                  pressureicp;    /*/< Pressure*/
} st_sensorsICP_t;
